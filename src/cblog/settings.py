...
DATABASES = {
    'default': {
        ...
        'HOST': 'clarusway.coy1fguugil2.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'cstkrstk-blog-django' # please enter your s3 bucket name
