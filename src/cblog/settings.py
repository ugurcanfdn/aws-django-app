...
DATABASES = {
    'default': {
        ...
        'HOST': 'osvaldo-django.cbanmzptkrzf.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'django.osvaldo' # please enter your s3 bucket name
