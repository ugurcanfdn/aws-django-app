...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Pl123456789',
        'HOST': 'cstkrstk.coy1fguugil2.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesoktayblog' # please enter your s3 bucket name
